			...
			<div class="widget-box"> <!-- Empieza el recuadro con su titulo -->
				...
				<div class="widget-body">
					<div class="widget-main">
						<div class="widget-main">
							<form class="form-horizontal" role="form" action="<?php echo base_url() ?>seguridad/AbmUsuarios/recibirDatos/" method="post" name="formMedicamento"><!-- Comienza formulario -->
								...
								<div class="form-group" hidden> <!-- Empieza una linea del formulario -->
									<label class="col-sm-3 control-label no-padding-right" for="rut">Empleado</label>
										<div class="col-sm-4">
											<input class="form-control" id="idEmpleado" name="idEmpleado" placeholder="" value="<?=$emp->idEmpleado?>">
						                </div> 
								</div>
