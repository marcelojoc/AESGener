...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-10-2017 a las 20:08:39
...
CREATE TABLE `complejo` (
  ...
  `actualMes` float NOT NULL,
  `targetMes` float NOT NULL,
  `ytdActual` float NOT NULL,
  `ytdTarget` float NOT NULL,
  `fyf` float NOT NULL,
  `fyBudget` float NOT NULL,
...
--
ALTER TABLE `kpi`
  MODIFY `idKPI` int(11) NOT NULL AUTO_INCREMENT;
--
